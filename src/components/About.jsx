...
const ServiceCard = ({ index, title, icon }) => {
  return (
    <Tilt className="xs:w-[250px] w-full">
      <motion.div
      variants={fadeIn("right", "spring", 0.7 * index, 1)}
      ...
      >
        ...
        >
          <img src={icon} alt={title} className="w-16 h-16 object-contain mt-0 mb-0 m-auto" />
...
const About = () => {
  return (
    <>
      ...
      and Three.js. I'm a quick learner and collaborate 
      closely with clients to create efficient, scalable, 
